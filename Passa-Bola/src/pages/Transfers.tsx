...
const mockTransfers: PlayerTransfer[] = [
  {
    ...
    fromClubLogo: 'https://via.placeholder.com/40x40/FF0000/FFFFFF?text=MU',
    toClub: 'Chelsea',
    toClubLogo: 'https://via.placeholder.com/40x40/034694/FFFFFF?text=CHE',
  ...
  },
  {
    id: '2',
    playerName: 'Kerolin',
    playerAvatar: '/attached_assets/stock_images/female_soccer_player_b8126497.jpg',
    position: 'Meia-Atacante',
    age: 24,
    nationality: 'Brasil',
    fromClub: 'North Carolina Courage',
    fromClubLogo: 'https://via.placeholder.com/40x40/B8860B/FFFFFF?text=NC',
    toClub: 'Corinthians',
    toClubLogo: 'https://via.placeholder.com/40x40/000000/FFFFFF?text=COR',
    transferType: 'permanent',
  ...
  },
  {
    ...
    playerAvatar: '/attached_assets/stock_images/female_soccer_player_2a3847ee.jpg',
    position: 'Atacante',
    age: 26,
    nationality: 'Brasil',
    fromClub: 'Corinthians',
    fromClubLogo: 'https://via.placeholder.com/40x40/000000/FFFFFF?text=COR',
    toClub: 'Angel City FC',
    toClubLogo: 'https://via.placeholder.com/40x40/FF69B4/FFFFFF?text=AC',
  ...
  },
  {
    ...
    nationality: 'Brasil',
    fromClub: 'Palmeiras',
    fromClubLogo: 'https://via.placeholder.com/40x40/006B3F/FFFFFF?text=PAL',
    toClub: 'Santos',
    toClubLogo: 'https://via.placeholder.com/40x40/FFFFFF/000000?text=SAN',
    transferType: 'free',
