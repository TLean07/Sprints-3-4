...
const mockMatches: Match[] = [
  {
    ...
    homeTeam: {
      ...
      logo: 'https://via.placeholder.com/40x40/000000/FFFFFF?text=COR',
    ...
    awayTeam: {
      ...
      shortName: 'Palmeiras',
      logo: 'https://via.placeholder.com/40x40/006B3F/FFFFFF?text=PAL',
    ...
    competition: {
      ...
      logo: 'https://via.placeholder.com/20x20/FFD700/000000?text=BR',
      country: 'Brasil',
      season: '2024',
      type: 'league'
    },
